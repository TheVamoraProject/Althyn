...
Item {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            height: 44; radius: 22; color: appsPage.pageCard; border { color: appsPage.pageBorder; width: 1 }
            ...
            RowLayout { anchors { fill: parent; leftMargin: 14; rightMargin: 10 }; spacing: 8
                ...
                TextInput {
                    Layout.fillWidth: true; color: appsPage.pageText; font.pixelSize: 13
                    placeholderText: "Search applications"; placeholderTextColor: appsPage.pageMuted
        ...
        Component.onCompleted: {
            ...
            Rectangle {
                x: 28; width: parent.width - 56; radius: 24; color: appsPage.pageCard
                border.color: appsPage.pageBorder; border.width: 1; clip: true
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            color: ahov ? appsPage.pageHover : "transparent"; Behavior on color { ColorAnimation { duration: 160 } }
                            property bool ahov: false

                            Rectangle { visible: index > 0; anchors { left: parent.left; right: parent.right; leftMargin: 16; top: parent.top }; height: 1; color: appsPage.pageBorder }
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    color: appsPage.dark ? "#27272a" : "#f4f4f5"
                                    Image {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { text: modelData.name; color: appsPage.pageText; font { pixelSize: 13; weight: Font.Medium } }
                                         Text {
                                             text: selectedApp === modelData.name
                                                   ? "Selected · " + modelData.perms
                                                   : modelData.perms
                                              color: selectedApp === modelData.name ? "#7dd3fc" : appsPage.pageMuted
                                             font.pixelSize: 11
                                         }
                                }

                                Text { text: "›"; color: appsPage.pageMuted; font.pixelSize: 18 }
                            }
